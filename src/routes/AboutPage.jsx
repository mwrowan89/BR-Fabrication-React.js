  ...
  return (
    ...
    <div>
      <div className="about">
        ...
        <h1 className="about-description">BR Fabrication creates one-of-a-kind, American made heirloom quality slab tables and furniture for commercial and residential spaces.
