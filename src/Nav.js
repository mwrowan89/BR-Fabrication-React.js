  ...
  return (
    ...
    <h2>Heirloom Quality Furniture for Commercial & Residential Spaces</h2> <br/>
      <div className="links">
        ...
        <a href="https://www.facebook.com/fromcheftotable/?locale=it_IT" target="_blank" rel="noopener noreferrer"><img src="../assets/images/facbook logo11.png" width="22" height="22" alt="FaceBook Link"/></a>
      </div>
  </div>
  );
}
